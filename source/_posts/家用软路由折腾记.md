...
然后通过朋友zhiyb给我邀请进了pt站（内站hdtime和外站torrentleech），在他的建议下使用aria2伪装正经客户端保种，但这存在一定性的风险，毕竟违规了，虽然外站对客户端无要求。
...
前面提到使用aria2伪装正经客户端保种，但aria2无法很好地管理文件，例如增删分类，所以我们可以考虑使用Transmission客户端，能够很好地对资源进行管理：
